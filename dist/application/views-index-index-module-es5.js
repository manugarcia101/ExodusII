...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-index-index-module"], {
  ...
  /***/
  function srcAppSharedServicesChartServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function ChartService() {
        ...
        this.barChartDataQli = [{
          data: ['85.00', '85.00', '84.89', '84.22', '83.56', '83.33', '83.22', '82.89', '82.89', '82.89'],
        ...
        this.barChartDataHealth = [{
          data: ['91', '88', '88', '87', '86', '86', '86', '86', '86', '85.1'],
          label: 'Health Index'
        }];
        ...
        this.barChartDataInfraestructure = [{
          data: ['100', '100', '100', '100', '100', '100', '100', '100', '100', '100'],
          label: 'Infraestructure Index'
        }];
        ...
        this.barChartDataEnvironment = [{
          data: ['72', '64', '64', '64', '60.1', '60.1', '60.1', '60.1', '60.1', '60.1'],
        ...
        this.barChartDataSafety = [{
          data: ['92', '91', '89.', '89', '87', '86', '85', '84.1', '84.1', '84.1'],
          label: 'Safety Index'
        }];
        ...
        this.barChartDataRent = [{
          data: ['88', '84.1', '84.1', '84.1', '84.1', '84.1', '84.1', '84.1', '84.1', '84.1'],
          label: 'Rent Index'
        }];
        ...
        this.barChartDataTraffic = [{
          data: ['100', '100', '90.1', '90.1', '90.1', '90.1', '90.1', '90.1', '90.1', '90.1'],
          label: 'Traffic Index'
        }];
      }
      ...
      _createClass(ChartService, [{
        key: "dataChart",
        value: function dataChart(index) {
          switch (index) {
            case 'Qli':
        ...
        key: "labelsChart",
        value: function labelsChart(index) {
          switch (index) {
            case 'Qli':
  ...
  /***/
  function srcAppViewsIndexIndexRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _indexes_indexes_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./indexes/indexes.component */
    "./src/app/views/index/indexes/indexes.component.ts");

    var routes = [{
      path: 'index/:id',
      component: _indexes_indexes_component__WEBPACK_IMPORTED_MODULE_2__["IndexesComponent"]
    }];
  ...
  /***/
  function srcAppViewsIndexIndexModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _indexes_indexes_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./indexes/indexes.component */
    "./src/app/views/index/indexes/indexes.component.ts");
    /* harmony import */
  ...
  /***/
  function srcAppViewsIndexIndexesIndexesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IndexesComponent", function () {
    ...
    var _shared_services_chart_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../shared/services/chart.service */
    "./src/app/shared/services/chart.service.ts");
    /* harmony import */
    ...
    var IndexesComponent =
    /*#__PURE__*/
    function () {
      function IndexesComponent(router, actRoute, apiService, mapService, chartService) {
        var _this = this;

        _classCallCheck(this, IndexesComponent);
      ...
      _createClass(IndexesComponent, [{
        ...
        value: function onMapChange() {
          ...
          this.apiService.getMapCities(this.index).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (data) {
            return _this2.mapService.buildMap(_this2.index, data, _this2.zoom);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function () {
            return _this2.barChartData = _this2.chartService.dataChart(_this2.index);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function () {
            return _this2.barChartLabels = _this2.chartService.labelsChart(_this2.index);
          })).subscribe();
        }
      }, {
        key: "ngOnDestroy",
    ...
    IndexesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [ng2_charts__WEBPACK_IMPORTED_MODULE_6__["BaseChartDirective"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkWithHref"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkActive"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_7__["MatMenuItem"]],
    ...
    IndexesComponent.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: IndexesComponent,
      factory: IndexesComponent.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IndexesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
        ...
        return [{
          ...
          type: _shared_services_map_service__WEBPACK_IMPORTED_MODULE_4__["MapService"]
        }, {
          type: _shared_services_chart_service__WEBPACK_IMPORTED_MODULE_5__["ChartService"]
        }];
      }, null);
    })();
    /***/
...
//# sourceMappingURL=views-index-index-module-es5.js.map